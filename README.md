...
##### Snapchat
- **[SnapEnhance](https://github.com/rhunk/SnapEnhance)** - Xposed module for enhancing many parts of Snpachat, allowing you to downloading snaps, annoymonus story viewing, auto-save chats etc. `FOSS` `[LP]`

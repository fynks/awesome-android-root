...
head:
  ...
  - - meta
    - name: keywords
      content: bootloader unlock, android bootloader, fastboot unlock, xiaomi mi unlock, samsung knox, pixel unlock, oneplus unlock, motorola unlock, oem unlocking, custom recovery, android rooting
  - - meta
    - name: author
